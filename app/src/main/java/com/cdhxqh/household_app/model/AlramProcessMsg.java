...
public class AlramProcessMsg implements Serializable {
    ...
    public AlramProcessMsg(int adid, int alramid, String alramtime, String alrmstatus, int caid, String description, int hasdanger, int helpcheck, int isprocess, String processResult, int uid, String username, String starttime) {
        this.adid = adid;
